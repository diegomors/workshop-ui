    ...
    <div className="container mx-auto px-4 py-8 max-w-2xl space-y-8 mb-20 animate-in fade-in duration-500">
      ...
      <div className="grid gap-6">
        ...
        {order.delivery_code && (order.status === 'PRONTO_PARA_RETIRADA' || order.status === 'EM_ROTA') && (
          <Card className="bg-warning-1 border-warning-2/30">
            <CardContent className="p-6 text-center space-y-2">
              <span className="text-sm font-medium text-warning-2">Código de Entrega</span>
              <div className="text-4xl font-black tracking-[0.5em] text-warning-2 pl-[0.5em]">
                {order.delivery_code}
              </div>
              <p className="text-xs text-warning-2">
