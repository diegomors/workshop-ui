  ...
  return (
    <div className="max-w-md mx-auto p-6 flex flex-col items-center text-center h-full justify-center">
      ...
      {order ? (
        ...
        <div className="bg-warning-1 border border-warning-2/30 rounded-lg p-4 w-full">
          <p className="text-sm text-warning-2">
            Seu pagamento foi processado. O pedido será criado em instantes.
          </p>
          <Link
            href="/orders"
            className="block mt-4 text-center bg-primary text-primary-foreground rounded-lg py-3 font-medium hover:bg-primary/90 transition-colors"
          >
            Ver Meus Pedidos
          </Link>
        </div>
