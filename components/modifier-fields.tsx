  ...
  return (
    <div className="space-y-4">
      {fields.map((field, index) => (
        <div key={field.id} className="flex flex-col sm:flex-row items-end sm:items-center gap-4 bg-neutral-10 p-4 border border-border rounded-md">
          <div className="w-full sm:flex-1 space-y-1">
            ...
            {form.formState.errors.modifiers?.[index]?.name && (
              <p className="text-negative-2 text-xs">{form.formState.errors.modifiers[index].name?.message}</p>
            )}
          </div>
          <div className="w-full sm:w-32 space-y-1">
            ...
            {form.formState.errors.modifiers?.[index]?.additional_price && (
              <p className="text-negative-2 text-xs">{form.formState.errors.modifiers[index].additional_price?.message}</p>
            )}
          </div>
