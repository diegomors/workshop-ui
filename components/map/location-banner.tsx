...
export function LocationBanner({ onRequestPermission }: LocationBannerProps) {
  return (
    <div className="absolute bottom-4 left-4 right-4 z-[1000] bg-card rounded-xl shadow-xl border border-blue-100 p-4 flex flex-col gap-3 max-w-sm mx-auto sm:right-auto sm:left-4">
      ...
      <Button 
        ...
        size="sm" 
        variant="default" 
        className="w-full font-semibold bg-primary hover:bg-primary/80 active:scale-95 transition-all"
      >
        Ativar Localização
      </Button>
    </div>
